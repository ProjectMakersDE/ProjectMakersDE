...
## horizOn — Backend as a Service for Games & Apps
...
| | |
|:--|:--|
| **Authentication** | User login, registration & cloud saves |
| **Leaderboards** | Global rankings & remote configuration |
...
| **SDKs** | Ready-to-use for **Unity** & **Godot** |
...
*Building games and tools with passion from Germany*
